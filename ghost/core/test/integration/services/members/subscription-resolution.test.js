...
(0, vitest_1.describe)('Subscription resolution priority', function () {
    (0, vitest_1.beforeAll)(testUtils.teardownDb);
    ...
    (0, vitest_1.afterEach)(testUtils.teardownDb);
    (0, vitest_1.it)('picks an active subscription over a cancelled one regardless of recency', async function () {
    ...
    (0, vitest_1.it)('picks the most recent active subscription on upgrade (Bronze → Silver)', async function () {
    ...
    (0, vitest_1.it)('picks the most recent active subscription on downgrade (Silver → Bronze)', async function () {
    ...
    (0, vitest_1.it)('treats trialing, past_due, and unpaid as active alongside active', async function () {
    ...
    (0, vitest_1.it)('excludes incomplete subscriptions from resolution — only sub is incomplete', async function () {
    ...
    (0, vitest_1.it)('excludes incomplete_expired subscriptions from resolution — only sub is incomplete_expired', async function () {
    ...
    (0, vitest_1.it)('ignores incomplete subs even when more recent than active subs', async function () {
    ...
    (0, vitest_1.it)('ranks by created_at, not start_date — older sub with future start_date does not out-rank newer sub', async function () {
    ...
    (0, vitest_1.it)('resolves to the only subscription when a member has just one', async function () {
    ...
    (0, vitest_1.it)('breaks identical-created_at ties deterministically by subscription id', async function () {
    ...
    (0, vitest_1.it)('returns no row for a member with no subscriptions', async function () {
    ...
    (0, vitest_1.it)('does not include comped members (no Stripe subscription) in subscription filters', async function () {
