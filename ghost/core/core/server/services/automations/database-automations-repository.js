...
async function loadActionOwner(trx, actionId) {
...
async function insertAction(trx, action) {
...
async function loadLatestActionRevision(trx, actionId) {
    const row = await trx('automation_action_revisions')
        .select('action_id', 'created_at', 'wait_hours', 'email_subject', 'email_lexical', 'email_design_setting_id')
...
async function insertActionRevision(trx, actionId, action, createdAt, latestRevision) {
